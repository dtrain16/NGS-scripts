...
echo "USAGE: BAM_to_bedgraph_5p.sh <.BAM> <bedfile annotation> <feature name> <distance>"
echo "EXAMPLE: BAM_to_bedgraph_5p.sh col0_rep1.sorted.bam Arabidopsis_thaliana.TAIR10.54_stop.bed stop 50"
exit 1
fi
