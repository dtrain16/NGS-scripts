...
sample_info <- data.frame(
  sample    = c("smg7_1", "smg7_2", "WT_1", "WT_2"),
  condition = rep(c("smg7", "WT"), each = 2),
  replicate = rep(1:2,2),
  bam       = sapply(
    c("smg7_rep1Aligned.sortedByCoord.out.bam", 
      "smg7_rep2Aligned.sortedByCoord.out.bam",
  ...
  coverage  = file.path(
    working_directory,
    paste0(c("smg7_1", "smg7_2", "WT_1", "WT_2"), ".rds")
  )
)
