...
sample_info <- data.frame(
  ...
  replicate = c(1:3,1:3),
  bam       = sapply(
	c("S16-5C_Aligned.sortedByCoord.out.bam", "S10-20C_Aligned.sortedByCoord.out.bam", "S25-34C_Aligned.sortedByCoord.out.bam",
...
write_tsv(out, "abh1-CvsWT-C_DERs_5p.bed", col_names=F)
