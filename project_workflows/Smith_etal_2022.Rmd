...
subset(hmap_rows, decay_cat == 3) %>% rownames_to_column("geneID") %>% write_csv("slow_decay_genes.csv")

subset(hmap_rows, decay_cat == 2) %>% rownames_to_column("geneID") %>% write_csv("moderate_decay_genes.csv")

subset(hmap_rows, decay_cat == 4) %>% rownames_to_column("geneID") %>% write_csv("rapid_decay_genes.csv")

subset(hmap_rows, decay_cat == 1) %>% rownames_to_column("geneID") %>% write_csv("fast_decay_genes.csv")
